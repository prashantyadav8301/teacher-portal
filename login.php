  ...
  <div class="container d-flex justify-content-center align-items-center vh-100">
    <div class="login-box p-5 shadow-lg rounded">
      <div class="text-center mb-4">
        ...
        <h6 class="text-danger">Login</h6>
      </div>
      <form method="post" action="index.php" id="login_user_form">
        <div class="mb-3">
        ...
        <div class="d-flex justify-content-between mb-4 flex-end">
          <a href="register.php" class="forgot-password-link">Don't have an account yet?</a>
        </div>

        <div class="d-grid">
          <input type="hidden" name="flag" value="login_flag">
          <input type="hidden" name="tab" value="login_tab">
          <input type="button" class="btn btn-dark" value="Login" onclick="user_login();">
        </div>
      </form>
    </div>
  </div>
